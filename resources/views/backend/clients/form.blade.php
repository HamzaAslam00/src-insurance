            ...
            <div class="panel panel-primary">
                <div class="tab-menu-heading">
                    <div class="tabs-menu1 d-flex justify-content-end">
                        <a href="{{ route('clients.index') }}" class="btn btn-sm dark-icon btn-primary" data-method="get"
                            data-title="Back">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab25">
                            <div class="col-xl-12 px-0">
                                <form action="{{ route('clients.store') }}" method="post" data-form="ajax-form" data-redirect='true'
