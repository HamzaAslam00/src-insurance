            ...
            <div class="panel panel-primary">
                <div class="tab-menu-heading">
                    <div class="tabs-menu1 d-flex justify-content-end">
                        <a href="javascript:void(0)" class="btn btn-sm dark-icon btn-primary" data-method="get"
                            data-title="Back" onclick="window.history.back();">
                                        ...
                                        <div class="col-md-3 d-flex justify-content-center align-items-center">
                                            <a href="javascript:void(0)" id="image-trigger-business">
                                                <div class="avatar business-chat-profile upload-button"
                                                    ...
                                                    <input readonly disabled class="file-upload-business d-none" type="file"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input readonly disabled type="text" class="form-control" id="business_name"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input readonly disabled type="text" class="form-control" id="owner_name"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input readonly disabled type="tel" class="form-control" id="phone"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="text" class="form-control" id="client_name"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="tel" class="form-control" id="client_phone"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="email" class="form-control" id="client_email"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="text" class="form-control" id="client_address"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="text" class="form-control" id="client_city"
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select disabled class="form-control form-select" name="client_state" id="client_state">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="text" class="form-control" id="client_zip_code"
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="">
                                                        <select disabled required class="form-control form-select select-style col-md-12" name="client_business_type" id="client_business_type">
                                                        ...
                                                        <div class="col-md-8 other">
                                                            <input readonly disabled type="text" class="form-control" name="client_business_type_other" id="client_business_type_other" placeholder="{{ __('messages.other_business_type') }}" value="{{ old('client_business_type_other', $client?->client_business_type_other ?? '') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="">
                                                        <select disabled required class="form-control form-select select-style col-md-12" name="client_business_organization" id="client_business_organization">
                                                        ...
                                                        <div class="col-md-8 other">
                                                            <input readonly disabled type="text" class="form-control" name="client_business_organization_other" id="client_business_organization_other" placeholder="{{ __('messages.other_business_organization') }}" value="{{ old('client_business_organization_other', $quoteData->organization_other ?? '') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="text" class="form-control" id="client_fein"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="number" min="0" step="1" class="form-control" id="client_no_of_employees"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="text" class="form-control" id="client_accountant_name"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="text" class="form-control" id="client_accountant_phone"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="text" class="form-control" id="client_accountant_email"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="text" class="form-control" id="client_estimated_sales"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly disabled type="text" class="form-control" id="client_estimated_payroll"
