        ...
        <div class="card-body">
            <div class="card-pay">
                <div class="tab-content">
                    <i class="fa fa-clock-o"></i> {{ __('messages.hours') }} <br> <br>

                        {{-- <div class="py-2 mb-1 fs-5 fw-bold">{{__('messages.kind')}}</div> --}}
                        <form action="{{ route('user.hours.store', $user_id) }}" method="post" data-refresh="refresh" data-datatable="#user_hour_datatable" data-form="ajax-form">
                            @csrf
                            ...
                            <div class="row d-flex">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="kind" id="kind" onchange="ChangeDropdowns(this.value);">
                                            <option value="" selected disabled>{{ __('messages.select_kind') }}</option>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="dateOption" id="oneDay" value="oneDay" checked>
                                            <label class="form-check-label" for="oneDay">{{ __('messages.one_day') }}</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="dateOption" id="multipleDays" value="multipleDays">
                                            <label class="form-check-label" for="multipleDays">{{ __('messages.multiple_days') }}</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4" id="startDateField">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="startDate" value="{{$date}}" name="start_date">
                                    </div>
                                </div>
                                <div class="col-md-4" id="endDateField" style="display: none;">
                                    <div class="form-group">
                                        <label class="form-label" for="endDate">{{ __('messages.end_date') }}</label>
                                        <input type="date" class="form-control" id="endDate" value="{{$date}}" name="end_date">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="project" id="project" >
                                            <option value="" selected disabled>{{ __('messages.select_project') }}</option>
                                ...
                                <div class="col-md-4" id= "typeworking">
                                    <div class="form-group">
                                        <label class="form-label" for="working_hour">{{ __('messages.select_working_type') }}</label>
                                        <select class="form-control select2" name="working_hour" id="working_hour">
                                            <option value="" selected disabled>{{ __('messages.select_working_type') }}</option>
                                            <option value="working_hours">{{ __('messages.working_hours') }}</option>
                                            <option value="working_home">{{ __('messages.billable_hours_working_from_home') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4" id= "typeovertime" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="overtime" id="overtime_type" style="width: 100%">
                                            <option value="" selected disabled>{{ __('messages.select_over_time') }}</option>
                                            <option value="overtime">{{ __('messages.overtime') }}</option>
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    <button type="submit" class="btn btn-primary" data-button="submit">{{ __('messages.save') }}</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <form action="{{ route('user.hours.store', $user_id) }}" method="post" data-datatable="#user_hour_datatable" data-refresh="refresh" data-form="ajax-form">
                            @csrf
                            ...
                            <div class="row d-flex">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('messages.choose_the_days_option') }}</label>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="dateOption" id="oneDay_km" value="oneDay" checked>
                                            <label class="form-check-label" for="oneDay_km">{{ __('messages.one_day') }}</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="dateOption" id="multipleDays_km" value="multipleDays">
                                            <label class="form-check-label" for="multipleDays_km">{{ __('messages.multiple_days') }}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4" id="startDateField_km">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="startDate_km" value="{{$date}}" name="start_date">
                                    </div>
                                </div>
                                <div class="col-md-4" id="endDateField_km" style="display: none;">
                                    <div class="form-group">
                                        <label class="form-label" for="endDate">{{ __('messages.end_date') }}</label>
                                        <input type="date" class="form-control" id="endDate_km" value="{{$date}}" name="end_date">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label" for="project">{{ __('messages.select_project') }}</label>
                                        <select class="form-control select2" name="project" id="project" required style="width: 100%">
                                            <option value="" selected disabled>{{ __('messages.select_project') }}</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label" for="number_km">{{ __('messages.total_number_of_km,s') }}</label>
                                        <input type="number" min="0" step="0.01" class="form-control" id="number_km" name="kilometer">
                                    </div>
                                </div>
                            </div>
