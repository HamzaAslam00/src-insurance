                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab25">
                                    <div class="col-xl-12 px-0">
                                        <form action="{{ route('profile.update', auth()->user()->id) }}" method="post" data-confirm="yes" data-form="ajax-form" enctype="multipart/form-data">
                                            @method('PUT')
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control" id="email" name="email"
                                                            placeholder="{{__('messages.email_address')}}" value="{{ auth()->user()->email }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" class="form-control" id="phone" name="phone"
                                                            placeholder="{{__('messages.contact_number')}}" value="{{ auth()->user()->phone }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                ...
                                <div class="tab-pane" id="tab26">
                                    <div class="col-xl-12 px-0">
                                        <form action="{{ route('change-password', auth()->user()->id) }}" method="post"
                                            ...
                                            @method('PUT')
                                            <div class="form-group">
                                                <label class="form-label" for="current_password">{{__('messages.current_password')}}
                                                    </label>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary" data-button="submit">{{__('messages.change_password')}}</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
